...
export default function Hero() {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-water/10 rounded-full blur-3xl animate-pulse-slow" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-white/90 text-sm font-medium">Club de Natación - El Retiro, Antioquia</span>
          </motion.div>
