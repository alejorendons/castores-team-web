...
export default function Equipment() {
  return (
    <section id="tienda" className="py-20 md:py-32 bg-secondary">
              ...
              >
                <div className="h-full p-6 rounded-2xl bg-white/[0.06] border border-white/10 hover:bg-white/[0.10] hover:border-white/20 transition-all duration-300 group">
                  <div className="flex items-start gap-4">
                    <div className="w-16 h-16 rounded-xl bg-water/15 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                      <Icon size={24} className="text-water" />
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        <h3 className="font-semibold text-white">{item.name}</h3>
                        <span className="text-xs text-water bg-water/10 px-2 py-1 rounded-md">
                          {item.category}
                        </span>
                      </div>
                      ...
                      <button className="inline-flex items-center gap-2 text-sm text-primary font-medium hover:text-primary-dark transition-colors">
                        <ShoppingBag size={14} />
                        Ver productos
                      </button>
                    </div>
